...
type Props = {
  ...
  initialValues?: Partial<SubscriberCreateInput>
  onValid: (values: SubscriberCreateInput) => Promise<void>
}

export default function CreateSubscriberModal({ errorMess, onCancel, initialValues, onValid }: Props) {
  ...
  const {
    ...
    defaultValues: { ...defaultValuesSubscriberCreate, ...initialValues },
    resolver: zodResolver(SubscriberCreateInputSchema)
  })
          ...
          <form onSubmit={handleSubmit(onValid)}>
            <div className="w-full sm:flex sm:items-start">
              <div className="w-full mt-3 text-center sm:mt-0 sm:text-left">
                <h2 className="text-gray-900 dark:text-white text-lg font-semibold mt-2 mb-8">Create Subscriber</h2>
