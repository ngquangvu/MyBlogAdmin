...
import type { AdminCreateInput } from '@/schema/admin'

import { AdminCreateInputSchema, defaultValuesAdminCreate } from '@/schema/admin'

type Props = {
  errorMess: string
  onCancel: () => void

  initialValues?: Partial<AdminCreateInput>
  onValid: (values: AdminCreateInput) => Promise<void>
}

export default function CreateAdminModal({ errorMess, onCancel, initialValues, onValid }: Props) {
  ...
  const {
    ...
    defaultValues: { ...defaultValuesAdminCreate, ...initialValues },
